...
export const themes: Theme[] = [
  ...
  questions: [
    ...
    {
      question: 'Вопрос third темы 1',
      answers: ['Ответ первый', 'Правильный ответ', 'Ответ 3'],
      rightAnswer: 'Правильный ответ: Правильный первый',
      link: 'ссылка',
      textLink: 'текст ссылки',
    },
    {
      question: 'Вопрос четвертый первой темы',
      answers: ['Ответ первый 4 вопроса', 'Второй ответ', 'Ответ третий четвертого вопроса'],
      rightAnswer: 'Правильный ответ: Ответ третий четвертого вопроса',
      link: 'ссылка',
      textLink: 'текст второй ссылки',
    },
  ]
