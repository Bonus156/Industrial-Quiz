...
export function GetPage() {
  ...
  return (
    <div className="get-page container mx-auto flex-grow">
      ...
      <p className="rules">1. Пройти тест на <a href="https://test.ucp.by/">сайте Госпромнадзора "https://test.ucp.by/"</a> из числа тех, которых еще нет в <Link className="underline hover:no-underline" to={'/'}>списке доступных тем</Link>.</p>
